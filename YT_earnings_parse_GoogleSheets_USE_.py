...
Changes from improved version:
 1. Added Google Sheets API integration
 2. Writes data to specific tabs based on the month of the earnings
 3. Creates tabs if they don't exist
 4. Clears existing data before writing new data
...
SHEET_ID = "1BMcv_gBcaGj3spnROWmVE9sv0r_A8Id1aAL9pye9rH4"
...
def write_to_sheet(service, sheet_id, sheet_name, dataframe):
    ...
    try:
        ...
        for idx, row in dataframe.iterrows():
            ...
            row_data = [
                row['State'],
                f'=XLOOKUP(D{row_num},JobCodeImport!$D$3:$D$1000,JobCodeImport!$E$3:$E$1000)',  # Job Code formula
                row['Channel ID'],
                ...
                row['4 - Detail'],
                row['Value'],
                f'=IF(H{row_num}="Snap",XLOOKUP(D{row_num}, JobCodeImport!$D$3:$D, JobCodeImport!$N$3:$N),IF(H{row_num}="FB",XLOOKUP(D{row_num}, JobCodeImport!$D$3:$D, JobCodeImport!$M$3:$M),XLOOKUP(D{row_num}, JobCodeImport!$D$3:$D, JobCodeImport!$L$3:$L)))'  # Current Split Lookup formula
            ]
            data_rows.append(row_data)
        
        # Then, add corresponding expense rows
        for idx, row in dataframe.iterrows():
            ...
            expense_row_data = [
                ...
                'Payout - ' + row['2 - Subcategory'],  # Add "Payout - " prefix
                row['Actual Date'],  # Same as revenue
                row['3 - Specifier'],  # Same as revenue
                row['4 - Detail'],  # Same as revenue
                f'=J{revenue_row_num}*K{revenue_row_num}',  # Value * Split percentage
